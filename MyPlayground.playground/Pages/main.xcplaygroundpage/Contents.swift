...
*/
// write your code here -- i think it should be a float and it will decrease or hopefully increase in time

var bankAccountBalance: Float = 100
...
*/
// write your code here
print("my new puppy's name is \(nameOfMyPuppy).")
...
*/
// write your code here
print("I just got a new puppy named \(nameOfMyPuppy) and she is awesome!")
...
*/
// write your code here - it's a constant so you can't change it unless you assign it to a new var , or change the name to a var instead of a let/constant
var myPuppysNewName = nameOfMyPuppy
myPuppysNewName = "Nutella"
